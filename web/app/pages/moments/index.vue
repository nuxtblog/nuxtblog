  ...
  <div class="min-h-screen pb-16">
    ...
    <PageContent>
      ...
      <div v-if="loading" class="space-y-4 ">
        <div v-for="i in 5" :key="i" class="rounded-md bg-default ring-1 ring-default shadow-sm p-4">
      ...
      <!-- Empty -->
      <div v-else-if="moments.length === 0" class="rounded-md bg-default ring-1 ring-default shadow-sm overflow-hidden ">
        <div class="py-20 flex flex-col items-center gap-3 text-center px-4">
          ...
          <p class="font-semibold text-highlighted">暂无动态</p>
      ...
      <div v-else class=" space-y-4">
        <div
          ...
          class="rounded-md bg-default ring-1 ring-default shadow-sm p-4">
          <!-- Author row -->
          <div class="flex items-center gap-3 mb-3">
            <div
    ...
    <!-- Pagination -->
    <PageFooter v-if="total > pageSize">

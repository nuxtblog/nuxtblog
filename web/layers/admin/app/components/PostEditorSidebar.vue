    ...
    <div class="p-4 space-y-6">
      ...
      <div>
        <h3 class="text-sm font-semibold text-highlighted mb-3">
          {{ t("admin.posts.editor.publish_settings") }}
        </h3>
        <div class="space-y-3">
          ...
          <UFormField :label="t('admin.posts.editor.published_at')">
            ...
            <p v-if="isScheduled" class="mt-1.5 flex items-center gap-1 text-xs text-primary">
          ...
          <UFormField v-if="(authStore.user?.role ?? 0) >= 3" :label="t('admin.posts.editor.author_label')">
      ...
      <div v-if="!simple">
        <h3 class="text-sm font-semibold text-highlighted mb-3">
          {{ t("admin.posts.editor.display_settings") }}
        </h3>
        <div class="space-y-3">
      ...
      <div>
        <h3 class="text-sm font-semibold text-highlighted mb-3">
          {{ t("admin.posts.editor.layout_settings") }}
        </h3>
        <div class="space-y-3">
      ...
      <div v-if="!simple">
        <div class="flex items-center justify-between mb-3">
          <h3 class="text-sm font-semibold text-highlighted">
            {{ t("admin.posts.editor.categories") }}
          </h3>
          <UButton color="primary" variant="link" size="xs" @click="showAddCategoryModal = true">
      ...
      <div v-if="!simple">
        <div class="flex items-center justify-between mb-3">
          <h3 class="text-sm font-semibold text-highlighted">
            {{ t("admin.posts.editor.tags") }}
          </h3>
          <UButton color="primary" variant="link" size="xs" @click="showAddTagModal = true">
      ...
      <div v-if="!simple">
        <div class="flex items-center justify-between mb-3">
          <h3 class="text-sm font-semibold text-highlighted">
            {{ t("admin.posts.editor.downloads") }}
          </h3>
          <UButton color="primary" variant="link" size="xs" icon="i-tabler-plus" @click="addDownload">
            {{ t("common.add") }}
          </UButton>
        </div>
        <div class="space-y-2">
      ...
      <div>
        <h3 class="text-sm font-semibold text-highlighted mb-3">
          {{ t("admin.posts.editor.featured_image") }}
        </h3>
        <FeaturedImagePicker
      ...
      <div>
        <div class="flex items-center justify-between mb-3">
          <h3 class="text-sm font-semibold text-highlighted">
            {{ t("admin.posts.editor.meta_fields") }}
          </h3>
          <UButton color="primary" variant="link" size="xs" @click="addMetaField">
      ...
      <div>
        <h3 class="text-sm font-semibold text-highlighted mb-3">
          {{ t("admin.posts.editor.seo_settings") }}
        </h3>
        <div class="space-y-3">
      ...
      <div class="p-6">
        <form class="space-y-4" @submit.prevent="handleAddTag">
          ...
          <div class="flex gap-3 justify-end">
            <UButton color="neutral" variant="soft" type="button" @click="showAddTagModal = false">
              {{ t("common.cancel") }}
            </UButton>
    ...
    <template #content>
      <div class="p-6">
        <form class="space-y-4" @submit.prevent="handleCreateCategory">
          ...
          <div class="flex gap-3 justify-end">
            <UButton color="neutral" variant="soft" type="button" @click="showAddCategoryModal = false">
              {{ t("common.cancel") }}
            </UButton>
...
if (import.meta.client) {
  onMounted(async () => {
    ...
    finally { authorsLoading.value = false; }
  });
}
...
const handleAddTag = async () => {
  ...
  try {
    const created = await tagStore.addNewTag({ name: newTag.value.name, slug: newTag.value.slug || undefined });
...
const newCategory = ref({ name: "", slug: "", taxonomy: "category", description: "", parent_id: undefined as number | undefined });
